...
function excelImport(affa_id, flow_id, user_name, project_no){
    ...
    $('#excelImport').click(function(){
        ...
        $('#div_modal_tc6b9900ff2f11e6bcbd1c3e84e5807c .modal-body').html('<iframe id="theIframe" name="theIframe" width="100%" height="500px" frameborder="0" src="/node/grid/grid.html?affa_id='+ affa_id +'&user_name='+ encodeURIComponent(encodeURIComponent(user_name)) +'&flow_id=' + flow_id + '&project_no='+ project_no +'&type=import"></iframe>');
