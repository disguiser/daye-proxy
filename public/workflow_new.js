$(function(){
    ...
    if (flowid == 'faca20a152f311e6892e184f32ca6bca') { // 贷款投资合同录入流程
        ...
        $('#div_sfbe518f3e9911e6ad2d184f32ca6bca label:eq(0)').html('<a href="/f/v/objlist?clsid=c588f5c0c81311e68438005056a687a8&pagid=c588f606c81311e694c1005056a687a8" target="_blank">' + $('#div_sfbe518f3e9911e6ad2d184f32ca6bca label').html() + '</a>')
    } else if (flowid == 'p5b270cfdbdd11e691db1c3e84e5807c') { // 财产信托合同登记流程
        $('#div_pbce5bdedc9711e6a54d1c3e84e5807c label:eq(0)').html('<a href="/f/v/objlist?clsid=c588f5c0c81311e68438005056a687a8&pagid=c588f606c81311e694c1005056a687a8" target="_blank">' + $('#div_pbce5bdedc9711e6a54d1c3e84e5807c label').html() + '</a>')
    }
});
// 代理编辑函数 贷款投资合同录入流程
