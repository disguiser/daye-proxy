        ...
        <div class="span12">
            <div id="div_c8659880539611e68c9bb888e335e00a" class="control-group">
                ...
                <div class="controls" id="divVal_c8659880539611e68c9bb888e335e00a">
                    <button type="button" onclick="chYdj()">预登记</button>
                    <button type="button" onclick="chYdj()">初始登记</button>
                    <button type="button" onclick="chYdj()">终止登记</button>
                    <button type="button" onclick="chYdj()">事前报告登记11</button>
                    ...
                    function chYdj() {
                        // window.open("/node/1.html","_blank","");
                        let query = location.href.substr(location.href.indexOf('?') + 1)
                        jQuery('#modal_frameContainer_title').html('预登记');
                        jQuery('#modalFrameContainer').attr('src','/node/printPayNotice.html?' + query);
